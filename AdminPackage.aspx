<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminPackage.aspx.cs" Inherits="AdminPackage" %>
...
<div class="formbg">
    ...
    <div class="addbtn">
           <asp:Button ID="Button2" class="btnn" runat="server" Text=" +  Add Package " 
...
<RowStyle CssClass="rows"></RowStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [tblPackage]"
         UpdateCommand="UPDATE [tblPackage] set PName=@PName,Fees=@Fees,Descr=@Descr,Duration=@Duration where PID=@PID"
        DeleteCommand="delete from [tblPackage] where PID=@PID">
        </asp:SqlDataSource>
