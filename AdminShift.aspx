<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminShift.aspx.cs" Inherits="AdminShift" %>
...
<div class="formbg">
    ...
    <div class="addbtn">
           <asp:Button ID="Button2" class="btnn" runat="server" Text=" +  Add Shift " 
...
<RowStyle CssClass="rows"></RowStyle>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [tblShift]"
         UpdateCommand="UPDATE [tblShift] set SName=@SName,Stime=@Stime,Etime=@Etime where SID=@SID"
        DeleteCommand="delete from [tblShift] where SID=@SID">
        </asp:SqlDataSource>
