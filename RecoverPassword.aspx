<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage.master" AutoEventWireup="true" CodeFile="RecoverPassword.aspx.cs" Inherits="RecoverPassword" %>
...
<div class="for-img">
    ...
    <div class="form-wrapper">
        ...
        <asp:Button ID="btnRecover" runat="server" Text="Send Otp" class="button" onclick="btnRecover_Click1" 
            />
